...
export const LEVELS_META = {
  ...
  '1-3': { timeLimit: 300, lowTimeThreshold: 90,  alertLastSeconds: 10, timeBonusPerSecond: 5, flagBonus: [100,400,800,2000,5000] },
  ...
  '2-3': { timeLimit: 300, lowTimeThreshold: 90,  alertLastSeconds: 10, timeBonusPerSecond: 5, flagBonus: [100,400,800,2000,5000] },
